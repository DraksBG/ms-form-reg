...
describe("UserDetail", () => {
    ...
    it("renderds all inputs with mocked data to be filled", () => {
        ...
        const userDetailsInputs: INamesInputsFields = mockInputs;
        const inputErrors: INamesInputErrors = mockInputsErrors;
        const birthDayInputs: IBirthDayInputsFields = mockBirthDayInputs;
        const birthDayInputErrors: IBirthDayInputsErrors =
            mockBirthDayInputsErrors;
        const isAllUserDetailsFieldsValid = true;
        const storeValues = {
            userDetailsInputs,
            inputErrors,
            birthDayInputs,
        ...
        expect(screen.getByTestId("day-input")).toHaveValue(
            mockBirthDayInputs.day
        );
    ...
    it("Check if the user can type on the inputs and if the regex are vlid", () => {
        ...
        const monthInput = screen.getByTestId(
            "month-input"
        ) as HTMLInputElement;
