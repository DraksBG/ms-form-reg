...
const GenderSelect: FC = ({}) => {
    const { userDetailsInputs, handleChange } = useContext(UserDetailsContex);
    ...
    return (
        <div className="flex flex-col w-2/5 pl-2">
            <div className="flex flex-col text-xs text-slate-500 ">
                ...
                <span>
                    Your Date of Birth cannot be changed later and will be used
                    if you need to Reset Your Password so{" "}
                    <b>please ensure it is correct.</b>
                </span>
            </div>
                ...
                <div className="flex">
                    <div className="flex">
                        <input
                            ...
                            checked={userDetailsInputs?.gender === "Male"}
                            readOnly
                        />
                        <label
                            htmlFor="male-input"
                    ...
                    <div className="flex">
                        <input
                            ...
                            className="mr-2"
                            onChange={handleChange}
                            checked={userDetailsInputs?.gender === "Female"}
                            readOnly
                        />
                        <label
