...
import { IAccountDetailsContextProps } from "../../context/ContextTpes.type";
...
describe("AccountDetail", () => {
    ...
    it("user types on input fields", () => {
        ...
        const securityQuestionAInput = screen.getByTestId(
            "security-question-1"
        );
        const securityQuestionBInput = screen.getByTestId(
            "security-question-2"
        );
    ...
    it("testing context provider with inital values", () => {
        ...
        const storeValues: IAccountDetailsContextProps = {
            inputs,
            handleChange,
            isAllAccountDetailsFieldsValid: true,
        };
